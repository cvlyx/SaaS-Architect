...
const FALLBACK_PACKS: IndustryPack[] = [
  ...
  { id: 19, name: "Non-Profit", slug: "non-profit", description: "Donor and volunteer management for organizations", features: ["Donor tracking", "Volunteer scheduling", "Campaign management"], roles: ["director", "coordinator", "volunteer"], icon: "Heart", color: "#ec4899" },
  { id: 20, name: "Legal", slug: "legal", description: "Case and document management for law firms", features: ["Case tracking", "Document workflow", "Client portal"], roles: ["partner", "associate", "paralegal", "admin"], icon: "Scale", color: "#6366f1" },
  { id: 23, name: "Manufacturing", slug: "manufacturing", description: "Production and supply chain management", features: ["Production runs", "Supplier tracking", "Quality control"], roles: ["plant_manager", "supervisor", "operator", "inspector"], icon: "Factory", color: "#a16207" },
  { id: 24, name: "Real Estate", slug: "real-estate", description: "Property and client management for agencies", features: ["Property listings", "Client CRM", "Lease tracking"], roles: ["agent", "broker", "manager"], icon: "Building", color: "#14b8a6" },
  { id: 25, name: "Hospitality", slug: "hospitality", description: "Hotel and restaurant management tools", features: ["Room booking", "Guest profiles", "Service management"], roles: ["manager", "front_desk", "housekeeping", "chef"], icon: "Hotel", color: "#f97316" },
  { id: 26, name: "Transportation", slug: "transportation", description: "Logistics and fleet management solutions", features: ["Fleet tracking", "Route planning", "Driver management"], roles: ["dispatcher", "driver", "manager"], icon: "Truck", color: "#64748b" },
  { id: 27, name: "Media", slug: "media", description: "Content and editorial workflow management", features: ["Content calendar", "Editorial workflow", "Asset library"], roles: ["editor", "writer", "designer", "publisher"], icon: "Newspaper", color: "#dc2626" },
  { id: 28, name: "Consulting", slug: "consulting", description: "Client engagement and project delivery tools", features: ["Client CRM", "Engagement tracking", "Resource planning"], roles: ["partner", "consultant", "analyst"], icon: "Briefcase", color: "#2563eb" },
  { id: 29, name: "Government", slug: "government", description: "Public sector workflow and permit management", features: ["Permit processing", "License renewals", "Service requests"], roles: ["clerk", "officer", "admin", "inspector"], icon: "Government", color: "#4f46e5" },
];
