...
import { Truck, TrendingUp, Users, MapPin, Activity, Package, Clock } from "lucide-react";
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Track deliveries, vehicles, routes, and logistics operations.
        </p>
      </div>
        ...
        <motion.div variants={itemVariants}>
          <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">On route</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div variants={itemVariants}>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <div className="col-span-4 rounded-xl border bg-card text-card-foreground shadow">
           <div className="p-6">
             ...
             <p className="text-sm text-muted-foreground mt-1">Manage transportation operations</p>
             ...
             <div className="grid grid-cols-2 gap-4 mt-6">
               <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted/50 transition-colors cursor-pointer">
                 ...
                 <div>
                   <div className="font-medium">Dispatch Delivery</div>
                   <div className="text-xs text-muted-foreground">Assign route</div>
                 </div>
               </div>
               <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted/50 transition-colors cursor-pointer">
        ...
        <div className="col-span-3 rounded-xl border bg-card text-card-foreground shadow">
           <div className="p-6">
             ...
             <p className="text-sm text-muted-foreground mt-1">Logistics events</p>
             <div className="mt-6 space-y-4">
               <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                 <Activity className="h-4 w-4 text-green-500" />
                 <div>
                   <div className="text-sm font-medium">Package delivered - #12458</div>
               ...
               <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                 ...
                 <div>
                   <div className="text-sm font-medium">New shipment scheduled for tomorrow</div>
                   <div className="text-xs text-muted-foreground">12 stops</div>
                 </div>
               </div>
             </div>
           </div>
